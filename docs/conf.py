# -*- coding: utf-8 -*-
#
# Figurative documentation build configuration file, created by
...
htmlhelp_basename = "Figurativedoc"
...
latex_documents = [
    (master_doc, "Figurative.tex", "Figurative Documentation", "Trail of Bits", "manual")
]
...
man_pages = [(master_doc, "figurative", "Figurative Documentation", [author], 1)]
...
# rtd still does `import figurative`, we need to mock the environment
# enough to make Figurative importable. specifically, we need to mock
