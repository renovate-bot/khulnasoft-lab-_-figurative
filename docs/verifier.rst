Property based symbolic executor: figurative-verifier
====================================================
Figurative installs a separated CLI tool to do property based symbolic execution of smart contracts. ::

    $ figurative-verifier your_contract.sol

**figurative-verifier** initializes an emulated blockchain environment with a configurable set of
...
---------------------------------------
**figurative-verifier** will detect and test property methods written in the 
...
figurative-verifier allows to test for ALWAYS REVERTing property methods.
...
===========================
**figurative-verifier** needs to be pointed to the target contract containing any number of property methods.
...
If you do not provide specific accounts **figurative-verifier** will choose them for you.
...
And you can unleash the verifier like this::
    ...
    $figurative-verifier testtoken.sol  --contract_name TestToken
