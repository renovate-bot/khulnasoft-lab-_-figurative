...
from figurative import set_verbosity
from figurative.native import Figurative
from figurative.core.plugin import ExtendedTracer, Follower, Plugin
from figurative.core.smtlib.constraints import ConstraintSet
from figurative.core.smtlib.solver import Z3Solver
from figurative.core.smtlib.visitors import GetDeclarations

from figurative.utils import config

import copy
from figurative.core.smtlib.expression import *
...
def concrete_run_get_trace(inp):
    ...
    m1 = Figurative.linux(prog, concrete_start=inp, workspace_url="mem:")
    t = ExtendedTracer()
    # r = TraceReceiver(t)
...
def symbolic_run_get_cons(trace):
    ...
    """
    # mem: has no concurrency support. Figurative should be 'Single' process
    m2 = Figurative.linux(prog, workspace_url="mem:")
    f = Follower(trace)
    set_verbosity(VERBOSITY)
