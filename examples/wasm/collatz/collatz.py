...
# Tell Figurative to run the collatz function with the given argument generator.
# We use an argument generator function instead of a list of arguments because Figurative
...
def getchar(state, _addr):
    ...
    value, for which Figurative will produce all possible outputs.
...
# as an import.
m = FigurativeWASM("collatz.wasm", env={"getchar": getchar})
