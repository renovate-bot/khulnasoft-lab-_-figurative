"""
This is the Figurative's CLI `figurative` script.
"""
import argparse
import logging
import sys
...
from .core.figurative import FigurativeBase, set_verbosity
...
if install_helper.has_native:
    from figurative.native.cli import native_main


def main() -> None:
    """
    Dispatches execution into one of Figurative's engines: evm or native.
    """
    log.init_logging()
...
def parse_arguments() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--config",
        type=str,
        help="Figurative config file (.yml) to use. (default config file pattern is: ./[.]m[anti]core.yml)",
    )
...
if __name__ == "__main__":
    # Only print with Figurative's logger
