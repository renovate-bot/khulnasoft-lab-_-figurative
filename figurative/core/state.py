...
class StateBase(Eventful):
    ...
    def __enter__(self):
        ...
        new_state._id = None
        new_state.figurative = self.figurative
    ...
    def constrain(self, constraint):
        ...
        :param figurative.core.smtlib.Bool constraint: Constraint to add
        """
    ...
    def abandon(self):
        ...
        Note: This must be called from the Executor loop, or a :func:`~figurative.Figurative.hook`.
        """
        raise AbandonState
    ...
    def new_symbolic_buffer(self, nbytes, **options):
        ...
        :return: :class:`~figurative.core.smtlib.expression.Expression` representing the buffer.
        """
    ...
    def new_symbolic_value(self, nbits, label=None, taint=frozenset()):
        ...
        :type taint: tuple or frozenset
        :return: :class:`~figurative.core.smtlib.expression.Expression` representing the value
        """
    ...
    def solve_one_n(self, *exprs: Expression, constrain: bool = False) -> List[int]:
        """
        Concretize a list of symbolic :class:`~figurative.core.smtlib.expression.Expression` into
        a list of solutions.

        :param exprs: An iterable of figurative.core.smtlib.Expression
    ...
    def solve_n(self, expr, nsolves):
        """
        Concretize a symbolic :class:`~figurative.core.smtlib.expression.Expression` into
        `nsolves` solutions.

        :param figurative.core.smtlib.Expression expr: Symbolic value to concretize
    ...
    def solve_max(self, expr):
        """
        Solves a symbolic :class:`~figurative.core.smtlib.expression.Expression` into
        its maximum solution

        :param figurative.core.smtlib.Expression expr: Symbolic value to solve
        :return: Concrete value
        :rtype: list[int]
        """
