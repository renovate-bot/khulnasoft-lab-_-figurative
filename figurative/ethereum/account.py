...
class EVMAccount:
    def __init__(self, address=None, figurative=None, name=None):
        """
        Encapsulates an account.

        :param address: the address of this account
        :type address: 160 bit long integer
        :param figurative: the controlling Figurative
        """
        self._figurative = figurative
...
class EVMContract(EVMAccount):
    ...
    def __init_hashes(self):
        md = self._figurative.get_metadata(self._address)
        if md is not None:
