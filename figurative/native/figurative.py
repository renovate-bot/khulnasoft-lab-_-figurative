...
from ..core.figurative import FigurativeBase
...
class Figurative(FigurativeBase):
    ...
    def apply_model_hooks(self, path):
        ...
        import importlib
        from figurative import platforms
        ...
        with open(path, "r") as fnames:
            for line in fnames.readlines():
                ...
                importlib.import_module(f".platforms.{name_parts[0]}", "figurative")
                for n in name_parts:
    ...
    def linux(
        ...
        **kwargs,
        ...
        :param kwargs: Forwarded to the Figurative constructor
        :return: Figurative instance, initialized with a Linux State
        :rtype: Figurative
        """
        ...
        try:
            ...
            raise FigurativeError(f"Invalid binary: {path}")
    ...
    def decree(cls, path, concrete_start="", **kwargs):
        ...
        :param str concrete_start: Concrete stdin to use before symbolic input
        :param kwargs: Forwarded to the Figurative constructor
        :return: Figurative instance, initialized with a Decree State
        :rtype: Figurative
        """
        try:
    ...
    def init(self, f):
        ...
        function takes one :class:`~figurative.core.state.State` argument.
        """
    ...
    def add_hook(
        ...
        be a callable that takes one :class:`~figurative.core.state.State` argument.
        ...
        if isinstance(pc_or_sys, str):
            ...
            if isinstance(pc_or_sys, str):
                logger.warning(
                    ...
                    "Please refer to figurative/platforms/linux_syscalls.py to find the correct name."
                )
                return
    ...
    **kwargs,
    ...
    if entry_symbol is not None:
        ...
        if entry_pc is None:
            ...
            raise FigurativeError("Symbol not found")
        else:
