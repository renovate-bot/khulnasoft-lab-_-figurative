"""
Models here are intended to be passed to :meth:`~figurative.native.state.State.invoke_model`, not invoked directly.
"""
...
def variadic(func):
    ...
    take two parameters: a :class:`~figurative.native.state.State` object, and
