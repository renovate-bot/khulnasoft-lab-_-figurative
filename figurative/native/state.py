...
class State(StateBase):
    ...
    def add_hook(
        ...
        `callback` should be a callable that takes one :class:`~figurative.native.state.State` argument.
    ...
    def invoke_model(self, model):
        ...
        A `model` is a callable whose first argument is a `figurative.native.State` instance.
