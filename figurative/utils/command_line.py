"""
NOTE: Most of the code here is compatible/taken from Slither project ( https://github.com/khulnasoft-lab/slither ).
...
def output_detectors(detector_classes):
    """
    Copied from
    https://github.com/khulnasoft-lab/slither/blob/563d5118298e4cae7f0ea5f2a531f0dcdcebd64d/slither/utils/command_line.py
    """
    detectors_list = []
