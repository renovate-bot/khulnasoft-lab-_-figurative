...
class StateLists(Enum):
    """
    The set of StateLists tracked in FigurativeBase
    """
...
class MProcessingType(Enum):
    ...
    def to_class(self):
        return globals()[f"Figurative{self.title()}"]
...
class DetectorClassification(Enum):
    ...
    https://github.com/khulnasoft-lab/slither/blob/563d5118298e4cae7f0ea5f2a531f0dcdcebd64d/slither/detectors/abstract_detector.py#L11-L15
    """
