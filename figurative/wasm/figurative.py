...
class FigurativeWASM(FigurativeBase):
    """
    Figurative class for interacting with WASM, analagous to FigurativeNative or FigurativeEVM.
    """
...
def _make_initial_state(binary_path, env={}, sup_env={}, **kwargs) -> State:
    ...
    raise RuntimeError("FigurativeWASM only supports .wasm files at the moment")
