...
def convert_instructions(inst_seq) -> WASMExpression:
    """
    Converts instructions output from the parser into full-fledged Python objects that will work with Figurative.
    ...
    :return: The properly-typed instruction sequence in a format Figurative can use
    """
    out = []
...
class ConcretizeStack(Concretize):
    """Tells Figurative to concretize the value `depth` values from the end of the stack."""
