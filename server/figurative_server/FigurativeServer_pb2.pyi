...
class FigurativeLogMessage(google.protobuf.message.Message):
...
global___FigurativeLogMessage = FigurativeLogMessage

class FigurativeMessageList(google.protobuf.message.Message):
    DESCRIPTOR: google.protobuf.descriptor.Descriptor

    MESSAGES_FIELD_NUMBER: builtins.int
    @property
    def messages(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[global___FigurativeLogMessage]: ...
    def __init__(
        self,
        *,
        messages: collections.abc.Iterable[global___FigurativeLogMessage] | None = ...,
    ) -> None: ...
    def ClearField(self, field_name: typing_extensions.Literal["messages", b"messages"]) -> None: ...

global___FigurativeMessageList = FigurativeMessageList

class FigurativeState(google.protobuf.message.Message):
    DESCRIPTOR: google.protobuf.descriptor.Descriptor
...
global___FigurativeState = FigurativeState

class FigurativeStateList(google.protobuf.message.Message):
    DESCRIPTOR: google.protobuf.descriptor.Descriptor
    ...
    @property
    def active_states(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[global___FigurativeState]:
        """state categories in Figurative - based on figurative enums StateStatus and StateList"""
    @property
    def waiting_states(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[global___FigurativeState]: ...
    @property
    def forked_states(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[global___FigurativeState]: ...
    @property
    def errored_states(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[global___FigurativeState]: ...
    @property
    def complete_states(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[global___FigurativeState]: ...
    @property
    def paused_states(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[global___FigurativeState]: ...
    def __init__(
        self,
        *,
        active_states: collections.abc.Iterable[global___FigurativeState] | None = ...,
        waiting_states: collections.abc.Iterable[global___FigurativeState] | None = ...,
        forked_states: collections.abc.Iterable[global___FigurativeState] | None = ...,
        errored_states: collections.abc.Iterable[global___FigurativeState] | None = ...,
        complete_states: collections.abc.Iterable[global___FigurativeState] | None = ...,
        paused_states: collections.abc.Iterable[global___FigurativeState] | None = ...,
    ) -> None: ...
...
global___FigurativeStateList = FigurativeStateList

class FigurativeInstance(google.protobuf.message.Message):
    DESCRIPTOR: google.protobuf.descriptor.Descriptor
...
global___FigurativeInstance = FigurativeInstance
...
class FigurativeRunningStatus(google.protobuf.message.Message):
    DESCRIPTOR: google.protobuf.descriptor.Descriptor
...
global___FigurativeRunningStatus = FigurativeRunningStatus
...
class ControlStateRequest(google.protobuf.message.Message):
    ...
    STATE_ID_FIELD_NUMBER: builtins.int
    FIGURATIVE_INSTANCE_FIELD_NUMBER: builtins.int
    ACTION_FIELD_NUMBER: builtins.int
    state_id: builtins.int
    @property
    def figurative_instance(self) -> global___FigurativeInstance: ...
    action: global___ControlStateRequest.StateAction.ValueType
    def __init__(
        self,
        *,
        state_id: builtins.int = ...,
        figurative_instance: global___FigurativeInstance | None = ...,
        action: global___ControlStateRequest.StateAction.ValueType = ...,
    ) -> None: ...
    def HasField(self, field_name: typing_extensions.Literal["figurative_instance", b"figurative_instance"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["action", b"action", "figurative_instance", b"figurative_instance", "state_id", b"state_id"]) -> None: ...
