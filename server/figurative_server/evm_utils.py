...
from figurative.ethereum.plugins import (
    FilterFunctions,
...
# TODO(ekilmer): This could be refactored to reduce duplication in main figurative package
def setup_detectors_flags(
    detectors_to_exclude: List[str], additional_flags: str, m: FigurativeEVM
) -> argparse.Namespace:
    """parse and apply additional arguments for figurative EVM execution, CLI-style"""
