...
from figurative.core.plugin import IntrospectionAPIPlugin, StateDescriptor
from figurative.core.state import StateBase
from figurative.utils.enums import StateLists

logger = logging.getLogger(__name__)


class FigurativeServerIntrospectionPlugin(IntrospectionAPIPlugin):
    NAME = "FigurativeServerIntrospectionPlugin"

    @property
    def name(self) -> str:
        return "FigurativeServerIntrospectionPlugin"
    ...
    def create_state(self, state_id: int):
        ...
        state = self.figurative._load(state_id)
