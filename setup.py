...
setup(
    name="figurative",
    description="Figurative is a symbolic execution tool for analysis of binaries and smart contracts.",
    long_description_content_type="text/markdown",
    long_description=long_description,
    url="https://github.com/khulnasoft-lab/figurative",
    ...
    entry_points={
        "console_scripts": [
            "figurative = figurative.__main__:main",
            "figurative-verifier = figurative.ethereum.verifier:main",
        ]
    },
