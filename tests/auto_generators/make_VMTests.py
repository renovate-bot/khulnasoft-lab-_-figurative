...
## Initialize env:
cd figurative/tests/ && mkdir -p  ethereum_vm/VMTests_concrete 
...
import unittest
from binascii import unhexlify
from figurative import FigurativeEVM, Plugin
...
def gen_body(name, testcase):
    ...
    def test_{name}(self):
        ...
        m = FigurativeEVM(workspace_url="mem:", plugins=(used_gas_plugin,))
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        description="Figurative test generator for Ethereum BlockchainTests"
    )
    parser.add_argument(
