...
import shutil
from figurative.ethereum.plugins import VerboseTrace, KeepOnlyIfStorageChanges
...
class EthPluginsTests(unittest.TestCase):
    ...
    def test_verbose_trace(self):
        ...
        with self.assertLogs("figurative.core.figurative", level="INFO") as cm:
            self.mevm.finalize()
            prefix = "\x1b[34mINFO:\x1b[0m:m.c.figurative"
