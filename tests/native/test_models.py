...
from figurative.native.models import (
    variadic,
    isvariadic,
    strcmp,
    strlen_exact,
...
class StrlenTest(ModelTest):
    ...
    def test_symbolic_fork(self):
        ...
        m = Figurative(BIN_PATH, stdin_size=10, workspace_url=str(tmp_dir.name))
...
class StrcpyTest(ModelTest):
    ...
    def test_symbolic(self):
        ...
        # Figurative varies the hex output slightly per run
        expected = [
