...
from figurative.core.state_pb2 import StateList, State, MessageList
...
def fetch_update():
    ...
    while not finished:
        try:
            # Attempts to (re)connect to figurative server
...
class TestTui(unittest.TestCase):
    def test_simple_state_updates(self):
        ...
        self.assertEqual(subprocess.check_call(cmd), 0, "Figurative had a non-zero exit code")
