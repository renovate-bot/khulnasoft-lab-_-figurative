...
from figurative.wasm.types import Value_t
...
class TestSymbolicBranch(unittest.TestCase):
    ...
    def test_br_if(self):
        m = FigurativeWASM(test_br_if_file)
    ...
    def test_br_table(self):
        m = FigurativeWASM(test_br_table_file)
    ...
    def test_call_indirect(self):
        m = FigurativeWASM(test_call_indirect_file)
